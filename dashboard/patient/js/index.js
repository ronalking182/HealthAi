...
(function ($) {
    ...
    $.ajax({
        type: "GET",
        url: "https://localhost/healthg/dashboard/patient/data.php",
        data : formData,
        crossDomain: true,
        dataType: "json",
        encode: true,
    ...
    $.ajax({
      type: "GET",
      url: "https://loccalhost/healthg/dashboard/patient/geo_locate.php"+user,
      dataType: "json",
      encode: true,
    }).done(function (data) {
      ...
      function updatePatient(){
        ...
        let url = "https://loccalhost/healthg/dashboard/patient/update.php/" + patID;
